...
/**
 * This class implements the RegistrationManager interface using the DBus Signal
 * interface, where possible. It's used for the signal-cli dbus client mode
 * (--dbus, --dbus-system)
 */
public class DbusRegistrationManagerImpl implements RegistrationManager {
	...
	@Override
	public void register(final boolean voiceVerification, final String captcha, final String dddConfig)
	...
	@Override
	public void verifyAccount(final String verificationCode, final String pin)
